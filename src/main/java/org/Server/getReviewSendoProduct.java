...
public class getReviewSendoProduct {
    ...
    public List<String> searchSimilarProducts(String searchQuery) {
        ...
        try {
            // Tạo URL API tìm kiếm trên Sendo
            String encodedQuery = URLEncoder.encode(searchQuery, "UTF-8");
            String apiUrl = "https://api.sendo.vn/v1/products/search?query=" + encodedQuery + "&limit=40";
    ...
    public String getProductInfo(String productName) {
        try {
            ...
            String apiUrl = "https://api.sendo.vn/v1/products/search?query=" + encodedQuery + "&limit=1";
            ...
            String productId = firstProduct.getString("id");
            ...
            String imgUrl = productDetails.getJSONArray("images").getJSONObject(0).getString("url");
    ...
    private JSONObject loadProductDetails(String productId) throws IOException {
        String apiUrl = "https://api.sendo.vn/v1/products/" + productId;
    ...
    private JSONObject loadProductReviews(String productId) throws IOException {
        String apiUrl = "https://api.sendo.vn/v1/reviews?product_id=" + productId;
        String jsonResponse = Jsoup.connect(apiUrl).ignoreContentType(true).execute().body();
        return new JSONObject(jsonResponse);
    }
}